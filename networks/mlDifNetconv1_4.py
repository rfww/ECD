...
class mlDifNetconv1_4(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self.fuse = nn.Conv2d(8, num_classes, 3, padding=1)
    ...
    def forward(self, x, y):
        ...
        enc_final = self.fuse(torch.cat([enc4xy_res, enc3xy_res, enc2xy_res, enc1xy_res], 1))
        return enc4xy_res, enc3xy_res, enc2xy_res, enc1xy_res, enc_final
