...
class feature_extractor(nn.Module):
    def __init__(self, backbone='vgg16_bn', pretrained=True, freeze_backbone=False):
        ...
        self.seg1 = SegNetEnc(130,64,1,1)
        self.seg2 = SegNetEnc(258,128,1,1)
        self.seg3 = SegNetEnc(386,128,1,1)
        self.seg4 = SegNetEnc(770,256,1,1)
        self.seg5 = SegNetEnc(1026,512,1,1)
        ...
        self.encc1 = SegNetEnc2(64)
        self.encc2 = SegNetEnc2(128)
        self.encc3 = SegNetEnc2(256)
        self.encn1 = SegNetEnc2(64)
        self.encn2 = SegNetEnc2(128)
        self.encn3 = SegNetEnc2(256)
    ...
    def forward(self, x, y,dp):
        ...
        # print(rmp2.shape)
        # print(rmp1.shape)
        p5 = self.seg5(torch.cat([rmp5,c_enc5,F.upsample_bilinear(mp,scale_factor=1/2)],1))
        p4 = self.seg4(torch.cat([rmp4,c_enc4,mp],1))
        p3 = self.seg3(torch.cat([rmp3,c_enc3,F.upsample_bilinear(mp,scale_factor=2)],1))
        p2 = self.seg2(torch.cat([rmp2,c_enc2,F.upsample_bilinear(mp,scale_factor=4)],1))
        p1 = self.seg1(torch.cat([rmp1,c_enc1,F.upsample_bilinear(mp,scale_factor=4)],1))
