...
class feature_extractor(nn.Module):
    def __init__(self, backbone='vgg16_bn', pretrained=True, freeze_backbone=False):
        ...
        self.encc1 = SegNetEnc2(128)
        self.encc2 = SegNetEnc2(256)
        self.encc3 = SegNetEnc2(512)
        self.encn1 = SegNetEnc2(128)
        self.encn2 = SegNetEnc2(256)
        self.encn3 = SegNetEnc2(512)
    ...
    def forward(self, x, y,dp):
        ...
        ccp = self.sgp(torch.cat([
            pr1,
            F.upsample_bilinear(pr2, scale_factor=2),
            F.upsample_bilinear(pr3, scale_factor=4)
        ],1))
