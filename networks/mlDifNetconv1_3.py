...
class mlDifNetconv1_3(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        #self.enc4xy = SegNetEnc(256, 128, 0)
        self.enc3xy = SegNetEnc(128, 64, 0)
    ...
    def forward(self, x, y):
        ...
        #enc4xy = self.enc4xy(abs(enc4 - enc4y)) #128
        enc3xy = self.enc3xy(abs(enc3 - enc3y)) #6*128*80*80
        #print(enc3xy.size())
        ...
        enc_final = self.fuse(torch.cat([ enc3xy_res, enc2xy_res, enc1xy_res], 1))
        return  enc3xy_res, enc2xy_res, enc1xy_res, enc_final
