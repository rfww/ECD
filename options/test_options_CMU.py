...
class TestOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--cd-model-dir', default="./save_models2021/cmu/SC2D_20.pth", help='path to stored-model')
        ...
        self.parser.add_argument('--savedir', type=str, default='./save_results2021/cmu/', help='options. visualize the result of segmented picture, not just show IoU')
        #--------------------------------CIS config-----------------------------------
