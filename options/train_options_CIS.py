...
class TrainOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--model', default="cis", help='model to train,options:...')
        ...
        self.parser.add_argument('--savedir', type=str, default='./save_models2021/cis_depth_5/', help='savedir for models')
        ...
        self.parser.add_argument('--epoch-save', type=int,
                                 default=2)  # You can use this value to save model every X epochs
